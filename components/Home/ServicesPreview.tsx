...
> = {
    ...
    items: [
        {
            label: "Active Opportunities Pathway",
            imageSrc: "/images/lucent-images/4.jpeg",
            imageAlt: "Active Opportunities Pathway",
            href: "/what-we-do/active-opportunities-pathway",
        },
        {
            label: "Supported Shared Accommodation",
            imageSrc: "/images/lucent-images/32.jpeg",
            imageAlt: "Supported Shared accommodation",
            href: "/what-we-do/supported-shared-accommodation",
        },
        {
            label: "Nightly Self-contained",
            imageSrc: "/images/lucent-images/41.jpeg",
            imageAlt: "Nightly Self-contained",
            href: "/what-we-do/nightly-self-contained",
        },
    ],
